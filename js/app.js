...
const translations = {
    uz: {
        ...
        step2Desc: "Chiroyli va qulay menyu orqali xizmatlar yoki mahsulotlarni tanlaydi",
        step3Title: "Buyurtma beradi",
        step3Desc: "Manzilini/ma'lumotlarini kiritadi va kerakli xizmatlarni savatga qo'shadi",
    ...
    ru: {
        ...
        step2Desc: "Выбирает услуги или товары через красивое и удобное меню",
        step3Title: "Оформляет заказ",
        step3Desc: "Вводит данные и добавляет нужные услуги в корзину",
    ...
    en: {
        ...
        step2Desc: "Browses services or products using a beautiful native interface",
        step3Title: "Places an Order",
        step3Desc: "Selects items, enters details, and adds to cart",
